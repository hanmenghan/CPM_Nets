...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs-train', type=int, default=50, metavar='N',
    ...
    model = CPMNets(view_num, trainData.num_examples, testData.num_examples,
                    layer_size,
                    lsd_dim=args.lsd_dim,
                    learning_rate=learning_rate,
                    lamb=args.lamb)
    # train
    model.train(trainData.data, Sn_train,
                trainData.labels.reshape(trainData.num_examples), epoch[0], step=[10, 10])
